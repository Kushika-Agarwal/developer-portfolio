...
export const personalData = {
  ...
  description:
    "My name is KUSHIKA AGARWAL. I am a professional and enthusiastic programmer in my daily life. I am a quick learner with a self-learning attitude. I love to learn and explore new technologies and am passionate about problem-solving. I love almost all the stacks of web application development and love to make the web more open to the world. My core skill is based on JavaScript and I love to do most of the things using JavaScript. I am available for any kind of job opportunity that suits my skills and interests.",
  email: "kushikaagarwalg1080@gmail.com",
  phone: "7309330638",
  ...
  resume:
    "https://drive.google.com/file/d/1jsOlFk7Mn1nQ06IKRUWuzqSzqko5ftcI/view?usp=sharing",
};
```
